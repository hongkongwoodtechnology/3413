...
const LEAGUES = [
  ...
  // 歐洲聯賽
  { key: 'eng.1', name: 'Premier League', country: 'England', category: 'england', names: { 'zh-TW': '英格蘭超級聯賽', 'zh-CN': '英格兰超级联赛', 'es': 'Premier League', 'ja': 'プレミアリーグ', 'ko': '프리미어리그', 'pt': 'Premier League', 'la': 'Premier League', 'ru': 'Премьер-лига', 'fr': 'Premier League', 'de': 'Premier League', 'ar': 'الدوري الإنجليزي الممتاز' } },
  ...
  { key: 'nor.1', name: 'Eliteserien', country: 'Norway', category: 'europe', names: { 'zh-TW': '挪威超級聯賽', 'zh-CN': '挪威超级联赛', 'es': 'Eliteserien', 'ja': 'エリテセリエン', 'ko': '엘리테세리엔', 'pt': 'Eliteserien', 'la': 'Eliteserien', 'ru': 'Элитсерия', 'fr': 'Eliteserien', 'de': 'Eliteserien', 'ar': 'الدوري النرويجي الممتاز' }, aliases: ['Norway Eliteserien'] },
  ...
  { key: 'ger.1', name: 'Bundesliga', country: 'Germany', category: 'europe', names: { 'zh-TW': '德國甲級聯賽', 'zh-CN': '德国甲级联赛', 'es': 'Bundesliga', 'ja': 'ブンデスリーガ', 'ko': '분데스리가', 'pt': 'Bundesliga', 'la': 'Bundesliga', 'ru': 'Бундеслига', 'fr': 'Bundesliga', 'de': 'Bundesliga', 'ar': 'الدوري الألماني' } },
  { key: 'ger.w', name: 'Frauen-Bundesliga', country: 'Germany', category: 'europe', names: { 'zh-TW': '德國女子甲級聯賽', 'zh-CN': '德国女子甲级联赛', 'es': 'Bundesliga Femenina', 'ja': '女子ブンデスリーガ', 'ko': '프라우엔-분데스리가', 'pt': 'Bundesliga Feminina', 'la': 'Frauen-Bundesliga', 'ru': 'Женская Бундеслига', 'fr': 'Frauen-Bundesliga', 'de': 'Frauen-Bundesliga', 'ar': 'الدوري الألماني للسيدات' } },
  { key: 'svn.1', name: 'Prva Liga', country: 'Slovenia', category: 'europe', names: { 'zh-TW': '斯洛維尼亞甲級聯賽', 'zh-CN': '斯洛文尼亚甲级联赛', 'es': 'Prva Liga', 'ja': 'プルヴァ・リーガ', 'ko': '프르바리가', 'pt': 'Prva Liga', 'la': 'Prva Liga', 'ru': 'Первая лига', 'fr': 'Prva Liga', 'de': 'Prva Liga', 'ar': 'الدوري السلوفيني' } },
  { key: 'isr.1', name: 'Premier League', country: 'Israel', category: 'europe', names: { 'zh-TW': '以色列超級聯賽', 'zh-CN': '以色列超级联赛', 'es': 'Liga Premier de Israel', 'ja': 'イスラエル・プレミアリーグ', 'ko': '프리미어리그', 'pt': 'Premier League de Israel', 'la': 'Premier League', 'ru': 'Премьер-лига', 'fr': 'Premier League', 'de': 'Premier League', 'ar': 'الدوري الإسرائيلي الممتاز' }, aliases: ['Relegation Group', 'Championship Group'] },
  ...
  // Serbia
  { key: 'srb.1', name: 'Super Liga', country: 'Serbia', category: 'europe', names: { 'zh-TW': '塞爾維亞超級聯賽', 'zh-CN': '塞尔维亚超级联赛', 'es': 'Super Liga', 'ja': 'スーペルリーガ', 'ko': '수페르리가', 'pt': 'Super Liga', 'la': 'Super Liga', 'ru': 'Суперлига', 'fr': 'Super Liga', 'de': 'Super Liga', 'ar': 'الدوري الصربي الممتاز' }, aliases: ['Superliga'] },
  { key: 'srb.2', name: 'Prva Liga', country: 'Serbia', category: 'europe', names: { 'zh-TW': '塞爾維亞甲級聯賽', 'zh-CN': '塞尔维亚甲级联赛', 'es': 'Prva Liga', 'ja': 'プルヴァ・リーガ', 'ko': '프르바리가', 'pt': 'Prva Liga', 'la': 'Prva Liga', 'ru': 'Первая лига', 'fr': 'Prva Liga', 'de': 'Prva Liga', 'ar': 'الدوري الصربي الدرجة الأولى' } },
  
  // Malta
  { key: 'mlt.1', name: 'Malta Premier', country: 'Malta', category: 'europe', names: { 'zh-TW': '馬耳他超級聯賽', 'zh-CN': '马耳他超级联赛', 'es': 'Premier League de Malta', 'ja': 'マルタ・プレミアリーグ', 'ko': '몰타 프리미어리그', 'pt': 'Premier League de Malta', 'la': 'Melita Premier', 'ru': 'Премьер-лига Мальты', 'fr': 'Premier League maltaise', 'de': 'Maltesische Premier League', 'ar': 'الدوري المالطي الممتاز' }, aliases: ['Premier League'] },

  // Denmark
  { key: 'den.1', name: 'Superliga', country: 'Denmark', category: 'europe', names: { 'zh-TW': '丹麥超級聯賽', 'zh-CN': '丹麦超级联赛', 'es': 'Superliga Danesa', 'ja': 'スーペルリーガ', 'ko': '수페르리가', 'pt': 'Superliga Dinamarquesa', 'la': 'Superliga Danica', 'ru': 'Суперлига Дании', 'fr': 'Superliga Danoise', 'de': 'Dänische Superliga', 'ar': 'دوري السوبر الدنماركي' } },

  // Cyprus
  { key: 'cyp.1', name: '1st Division', country: 'Cyprus', category: 'europe', names: { 'zh-TW': '塞浦路斯甲級聯賽', 'zh-CN': '塞浦路斯甲级联赛', 'es': 'Primera División de Chipre', 'ja': 'キプロス・ファーストディビジョン', 'ko': '키프로스 1부 리그', 'pt': 'Primeira Divisão do Chipre', 'la': 'Divisio Prima', 'ru': 'Первый дивизион Кипра', 'fr': 'Première Division Chypriote', 'de': 'Zyprische First Division', 'ar': 'الدوري القبرصي الدرجة الأولى' } },

  // Belgium
  { key: 'bel.1', name: 'Belgian Pro League', country: 'Belgium', category: 'europe', names: { 'zh-TW': '比利時甲組聯賽', 'zh-CN': '比利时甲级联赛', 'es': 'Pro League de Bélgica', 'ja': 'ベルギー・プロ・リーグ', 'ko': '벨기에 프로 리그', 'pt': 'Pro League Belga', 'la': 'Belgian Pro League', 'ru': 'Про-лига Бельгии', 'fr': 'Pro League Belge', 'de': 'Belgische Pro League', 'ar': 'الدوري البلجيكي للمحترفين' }, aliases: ['Pro League'] },

  // Slovakia
  { key: 'svk.1', name: 'Super Liga', country: 'Slovakia', category: 'europe', names: { 'zh-TW': '斯洛伐克超級聯賽', 'zh-CN': '斯洛伐克超级联赛', 'es': 'Superliga de Eslovaquia', 'ja': 'ツォルゴン・リーガ', 'ko': '수페르리가', 'pt': 'Superliga Eslovaca', 'la': 'Superliga', 'ru': 'Суперлига Словакии', 'fr': 'Superliga Slovaque', 'de': 'Slowakische Superliga', 'ar': 'دوري السوبر السلوفاكي' } },

  // Romania
  { key: 'rou.1', name: 'Liga 1', country: 'Romania', category: 'europe', names: { 'zh-TW': '羅馬尼亞甲級聯賽', 'zh-CN': '罗马尼亚甲级联赛', 'es': 'Liga 1', 'ja': 'リーガ1', 'ko': '리가 1', 'pt': 'Liga 1', 'la': 'Liga 1', 'ru': 'Лига 1', 'fr': 'Liga 1', 'de': 'Liga 1', 'ar': 'الدوري الروماني' } },

  // Moldova
  { key: 'mda.1', name: 'Super Liga', country: 'Moldova', category: 'europe', names: { 'zh-TW': '摩爾多瓦超級聯賽', 'zh-CN': '摩尔多瓦超级联赛', 'es': 'Superliga de Moldavia', 'ja': 'モルドバ・スーパーリーガ', 'ko': '수페르리가', 'pt': 'Superliga Moldava', 'la': 'Super Liga', 'ru': 'Суперлига Молдовы', 'fr': 'Super Liga Moldave', 'de': 'Moldauische Super Liga', 'ar': 'دوري السوبر المولدوفي' } },

  // Scotland
  { key: 'sco.1', name: 'Premiership', country: 'Scotland', category: 'europe', names: { 'zh-TW': '蘇格蘭超級聯賽', 'zh-CN': '苏格兰超级联赛', 'es': 'Premiership', 'ja': 'スコティッシュ・プレミアシップ', 'ko': '프리미어십', 'pt': 'Premiership Escocesa', 'la': 'Premiership', 'ru': 'Премьершип', 'fr': 'Premiership Écossaise', 'de': 'Scottish Premiership', 'ar': 'الدوري الاسكتلندي الممتاز' } },

  // Egypt
  { key: 'egy.1', name: 'Premier League', country: 'Egypt', category: 'europe', names: { 'zh-TW': '埃及超級聯賽', 'zh-CN': '埃及超级联赛', 'es': 'Liga Premier de Egipto', 'ja': 'エジプト・プレミアリーグ', 'ko': '이집트 프리미어리그', 'pt': 'Premier League Egípcia', 'la': 'Premier League', 'ru': 'Премьер-лига Египта', 'fr': 'Premier League Égyptienne', 'de': 'Ägyptische Premier League', 'ar': 'الدوري المصري الممتاز' } },

  // Austria
  { key: 'aut.1', name: 'Bundesliga', country: 'Austria', category: 'europe', names: { 'zh-TW': '奧地利超級聯賽', 'zh-CN': '奥地利超级联赛', 'es': 'Bundesliga de Austria', 'ja': 'オーストリア・ブンデスリーガ', 'ko': '분데스리가', 'pt': 'Bundesliga Austríaca', 'la': 'Bundesliga', 'ru': 'Бундеслига Австрии', 'fr': 'Bundesliga Autrichienne', 'de': 'Österreichische Bundesliga', 'ar': 'الدوري النمساوي' } },

  // Peru
  { key: 'per.1', name: 'Liga 1', country: 'Peru', category: 'americas', names: { 'zh-TW': '秘魯甲級聯賽', 'zh-CN': '秘鲁甲级联赛', 'es': 'Liga 1', 'ja': 'リーガ1', 'ko': '리가 1', 'pt': 'Liga 1', 'la': 'Liga 1', 'ru': 'Лига 1', 'fr': 'Liga 1', 'de': 'Liga 1', 'ar': 'الدوري البيروفي' }, aliases: ['Apertura', 'Clausura'] },

  // South Africa
  { key: 'rsa.1', name: '1st Division', country: 'South Africa', category: 'africa', names: { 'zh-TW': '南非甲級聯賽', 'zh-CN': '南非甲级联赛', 'es': 'Primera División de Sudáfrica', 'ja': '南アフリカ・ファーストディビジョン', 'ko': '1st Division', 'pt': 'Primeira Divisão da África do Sul', 'la': 'Divisio Prima', 'ru': 'Первый дивизион ЮАР', 'fr': '1ère Division Sud-Africaine', 'de': 'Südafrikanische 1st Division', 'ar': 'دوري جنوب أفريقيا الدرجة الأولى' } },
  { key: 'rsa.premier', name: 'Premier League', country: 'South Africa', category: 'africa', names: { 'ar': 'الدوري الجنوب أفريقي الممتاز' } },

  // Libya
  { key: 'lby.1', name: 'Premier League', country: 'Libya', category: 'africa', names: { 'zh-TW': '利比亞超級聯賽', 'zh-CN': '利比亚超级联赛', 'es': 'Liga Premier de Libia', 'ja': 'リビア・プレミアリーグ', 'ko': '프리미어리그', 'pt': 'Premier League da Líbia', 'la': 'Premier League', 'ru': 'Премьер-лига Ливии', 'fr': 'Premier League Libyenne', 'de': 'Libysche Premier League', 'ar': 'الدوري الليبي الممتاز' } },
  ...
  { key: 'qat.1', name: 'Stars League', country: 'Qatar', category: 'asia', names: { 'zh-TW': '卡塔爾超級聯賽', 'zh-CN': '卡塔尔星级联赛', 'es': 'Stars League', 'ja': 'カタール・スターズリーグ', 'ko': '카타르 스타스 리그', 'pt': 'Stars League', 'la': 'Stars League', 'ru': 'Старс-лига', 'fr': 'Stars League', 'de': 'Stars League', 'ar': 'دوري نجوم قطر' } },
  { key: 'irq.1', name: 'Iraq Stars League', country: 'Iraq', category: 'asia', names: { 'zh-TW': '伊拉克星級聯賽', 'zh-CN': '伊拉克星级联赛', 'es': 'Liga de las Estrellas de Irak', 'ja': 'イラク・スターズリーグ', 'ko': '이라크 스타스 리그', 'pt': 'Liga das Estrelas do Iraque', 'la': 'Iraq Stars League', 'ru': 'Старс-лига Ирака', 'fr': 'Iraq Stars League', 'de': 'Iraq Stars League', 'ar': 'دوري نجوم العراق' }, aliases: ['Stars League'] },
  ...
  { key: 'mex.1', name: 'Liga MX', country: 'Mexico', category: 'americas', names: { 'zh-TW': '墨西哥超級聯賽', 'zh-CN': '墨西哥超级联赛', 'es': 'Liga MX', 'ja': 'リーガMX', 'ko': '리가 MX', 'pt': 'Liga MX', 'la': 'Liga MX', 'ru': 'Лига МХ', 'fr': 'Liga MX', 'de': 'Liga MX', 'ar': 'الدوري المكسيكي' } },
  { key: 'mex.2', name: 'Liga de Expansion MX', country: 'Mexico', category: 'americas', names: { 'zh-TW': '墨西哥甲組聯賽', 'zh-CN': '墨西哥甲级联赛', 'es': 'Liga de Expansión MX', 'ja': 'リーガ・デ・エクスパンシオンMX', 'ko': '리가 데 엑스판시온 MX', 'pt': 'Liga de Expansión MX', 'la': 'Liga de Expansion MX', 'ru': 'Лига Экспансьон МХ', 'fr': 'Liga de Expansión MX', 'de': 'Liga de Expansión MX', 'ar': 'دوري التوسع المكسيكي' }, aliases: ['Liga de Expansion', 'Expansion MX'] },
...
const TEAM_NAMES: Record<string, Record<string, string>> = {
  ...
  'Al Zawraa': { 'de': 'Al Zawraa', 'es': 'Al Zawraa', 'fr': 'Al Zawraa', 'ja': 'アル・ザウラー', 'ko': '알 자우라', 'la': 'Al Zawraa', 'pt': 'Al Zawraa', 'ru': 'Аль-Завраа', 'zh-CN': '扎维拉', 'zh-TW': '扎維拉' , 'th': 'อัล ซอรา' },
  ...
  'Aluminij': { 'de': 'Aluminij', 'es': 'Aluminij', 'fr': 'Aluminij', 'ja': 'アルミニイ', 'ko': '알루미니', 'la': 'Aluminij', 'pt': 'Aluminij', 'ru': 'Алюминий', 'zh-CN': '阿鲁米尼', 'zh-TW': '阿魯米尼' , 'th': 'อลูมิเนียม' },
  ...
  'Arsenal': { 'ar': 'أرسنال', 'de': 'Arsenal', 'es': 'Arsenal', 'fr': 'Arsenal', 'ja': 'アーセナル', 'ko': '아스널', 'la': 'Arsenal', 'pt': 'Arsenal', 'ru': 'Арсенал', 'zh-CN': '阿森纳', 'zh-TW': '阿森納' , 'th': 'อาร์เซนอล' },
  ...
  'Aston Villa': { 'ar': 'أستون فيلا', 'de': 'Aston Villa', 'es': 'Aston Villa', 'fr': 'Aston Villa', 'ja': 'アストン・ヴィラ', 'ko': '애스턴 빌라', 'la': 'Aston Villa', 'pt': 'Aston Villa', 'ru': 'Астон Вилла', 'zh-CN': '阿斯顿维拉', 'zh-TW': '阿斯頓維拉' , 'th': 'แอสตัน วิลล่า' },
  ...
  'Bodoe/Glimt': { 'de': 'Bodø/Glimt', 'es': 'Bodø/Glimt', 'fr': 'Bodø/Glimt', 'ja': 'ボデ/グリムト', 'ko': '보되/글림트', 'la': 'Bodoe/Glimt', 'pt': 'Bodø/Glimt', 'ru': 'Будё-Глимт', 'zh-CN': '博德闪耀', 'zh-TW': '博多格林特' , 'th': 'โบโด/กริตต์' },
  ...
  'Borussia Dortmund': { 'de': 'Borussia Dortmund', 'es': 'Borussia Dortmund', 'fr': 'Borussia Dortmund', 'ja': 'ボルシア・ドルトムント', 'ko': '보루시아 도르트문트', 'la': 'Borussia Dortmund', 'pt': 'Borussia Dortmund', 'ru': 'Боруссия Дортмунд', 'zh-CN': '多特蒙德', 'zh-TW': '多特蒙德' , 'th': 'โบรุสเซีย ดอร์ทมุนด์' },
  ...
  'Bournemouth': { 'ar': 'بورنموث', 'de': 'Bournemouth', 'es': 'Bournemouth', 'fr': 'Bournemouth', 'ja': 'ボーンマス', 'ko': '본머스', 'la': 'Bournemouth', 'pt': 'Bournemouth', 'ru': 'Борнмут', 'zh-CN': '伯恩茅斯', 'zh-TW': '伯恩茅斯' , 'th': 'บอร์นมัธ' },
  ...
  'Brentford': { 'ar': 'برينتفورد', 'de': 'Brentford', 'es': 'Brentford', 'fr': 'Brentford', 'ja': 'ブレントフォード', 'ko': '브렌트퍼드', 'la': 'Brentford', 'pt': 'Brentford', 'ru': 'Брентфорд', 'zh-CN': '布伦特福德', 'zh-TW': '布倫特福德' , 'th': 'เบรนท์ฟอร์ด' },
  ...
  'Brighton': { 'ar': 'برايتون', 'de': 'Brighton', 'es': 'Brighton', 'fr': 'Brighton', 'ja': 'ブライトン', 'ko': '브라이턴', 'la': 'Brighton', 'pt': 'Brighton', 'ru': 'Брайтон', 'zh-CN': '布莱顿', 'zh-TW': '布萊頓' , 'th': 'ไบรท์ตัน' },
  'Brighton & Hove Albion': { 'ar': 'برايتون', 'de': 'Brighton', 'es': 'Brighton', 'fr': 'Brighton', 'ja': 'ブライトン', 'ko': '브라이턴', 'la': 'Brighton', 'pt': 'Brighton', 'ru': 'Брайтон', 'zh-CN': '布莱顿', 'zh-TW': '布萊頓' , 'th': 'ไบรท์ตัน แอนด์ โฮฟ อัลเบี้ยน' },
  ...
  'Burnley': { 'ar': 'بيرنلي', 'de': 'Burnley', 'es': 'Burnley', 'fr': 'Burnley', 'ja': 'バーンリー', 'ko': '번리', 'la': 'Burnley', 'pt': 'Burnley', 'ru': 'Бернли', 'zh-CN': '伯恩利', 'zh-TW': '伯恩利' , 'th': 'เบิร์นลี่ย์' },
  ...
  'CD UT Cajamarca': { 'de': 'CD UT Cajamarca', 'es': 'CD UT Cajamarca', 'fr': 'CD UT Cajamarca', 'ja': 'CD UTカハマルカ', 'ko': 'CD UT 카하마르카', 'la': 'CD UT Cajamarca', 'pt': 'CD UT Cajamarca', 'ru': 'УТ Кахамарка', 'zh-CN': '卡哈马卡', 'zh-TW': '卡哈馬卡' , 'th': 'ซีดี ยูที กาฮามาร์ก้า' },
  ...
  'Chelsea': { 'ar': 'تشيلسي', 'de': 'Chelsea', 'es': 'Chelsea', 'fr': 'Chelsea', 'ja': 'チェルシー', 'ko': '첼시', 'la': 'Chelsea', 'pt': 'Chelsea', 'ru': 'Челси', 'zh-CN': '切尔西', 'zh-TW': '切爾西' , 'th': 'เชลซี' },
  ...
  'Cienciano': { 'de': 'Cienciano', 'es': 'Cienciano', 'fr': 'Cienciano', 'ja': 'シエンシアーノ', 'ko': '시엔시아노', 'la': 'Cienciano', 'pt': 'Cienciano', 'ru': 'Сьенсиано', 'zh-CN': '西恩夏诺', 'zh-TW': '西恩夏諾' , 'th': 'เซียนเซียโน' },
  ...
  'Crystal Palace': { 'ar': 'كريستال بالاس', 'de': 'Crystal Palace', 'es': 'Crystal Palace', 'fr': 'Crystal Palace', 'ja': 'クリスタル・パレス', 'ko': '크리스탈 팰리스', 'la': 'Crystal Palace', 'pt': 'Crystal Palace', 'ru': 'Кристал Пэлас', 'zh-CN': '水晶宫', 'zh-TW': '水晶宮' , 'th': 'คริสตัล พาเลซ' },
  'CS Petrocub': { 'de': 'CS Petrocub', 'es': 'CS Petrocub', 'fr': 'CS Petrocub', 'ja': 'CSペトロクブ', 'ko': 'CS 페트로쿠브', 'la': 'CS Petrocub', 'pt': 'CS Petrocub', 'ru': 'Петрокуб', 'zh-CN': '佩特罗古', 'zh-TW': '佩特羅古' , 'th': 'ซีเอส เปโตรคิวบ์' },
  ...
  'Dinamo Bucuresti': { 'de': 'Dinamo Bukarest', 'es': 'Dinamo Bucarest', 'fr': 'Dinamo Bucarest', 'ja': 'ディナモ・ブカレスト', 'ko': '디나모 부쿠레슈티', 'la': 'Dinamo Bucuresti', 'pt': 'Dinamo Bucareste', 'ru': 'Динамо Бухарест', 'zh-CN': '布加勒斯特迪纳摩', 'zh-TW': '布加勒斯特迪納摩' , 'th': 'ดินาโม บูคาเรสต์' },
  ...
  'Diyala': { 'de': 'Diyala', 'es': 'Diyala', 'fr': 'Diyala', 'ja': 'ディヤラ', 'ko': '디얄라', 'la': 'Diyala', 'pt': 'Diyala', 'ru': 'Дияла', 'zh-CN': '迪亚拉', 'zh-TW': '迪亞拉' , 'th': 'ดิยาลา' },
  ...
  'Everton': { 'ar': 'إيفرتون', 'de': 'Everton', 'es': 'Everton', 'fr': 'Everton', 'ja': 'エヴァートン', 'ko': '에버턴', 'la': 'Everton', 'pt': 'Everton', 'ru': 'Эвертон', 'zh-CN': '埃弗顿', 'zh-TW': '艾佛頓' , 'th': 'เอฟเวอร์ตัน' },
  ...
  'FC Rapid 1923': { 'de': 'FC Rapid 1923', 'es': 'FC Rapid 1923', 'fr': 'FC Rapid 1923', 'ja': 'ラピド・ブカレスト', 'ko': '라피드 부쿠레슈티', 'la': 'FC Rapid 1923', 'pt': 'FC Rapid 1923', 'ru': 'Рапид Бухарест', 'zh-CN': '布加勒斯特快速', 'zh-TW': '布加勒斯特快速' , 'th': 'เอฟซี ราปิด 1923' },
  ...
  'FC Sheriff': { 'de': 'FC Sheriff', 'es': 'FC Sheriff', 'fr': 'FC Sheriff', 'ja': 'FCシェリフ', 'ko': 'FC 셰리프', 'la': 'FC Sheriff', 'pt': 'FC Sheriff', 'ru': 'Шериф', 'zh-CN': '谢里夫', 'zh-TW': '謝里夫' , 'th': 'เอฟซี นายอำเภอ' },
  ...
  'FK Crvena Zvezda': { 'de': 'Roter Stern Belgrad', 'es': 'Estrella Roja', 'fr': 'Étoile Rouge', 'ja': 'レッドスター・ベオグラード', 'ko': '츠르베나 즈베즈다', 'la': 'Stella Rubra', 'pt': 'Estrela Vermelha', 'ru': 'Црвена Звезда', 'zh-CN': '贝尔格莱德红星', 'zh-TW': '貝爾格勒紅星' , 'th': 'เอฟเค เซอร์เวน่า ซเวซดา' },
  ...
  'FK Sarajevo': { 'de': 'FK Sarajevo', 'es': 'FK Sarajevo', 'fr': 'FK Sarajevo', 'ja': 'FKサラエヴォ', 'ko': 'FK 사라예보', 'la': 'FK Sarajevo', 'pt': 'FK Sarajevo', 'ru': 'Сараево', 'zh-CN': '萨拉热窝', 'zh-TW': '塞拉耶佛' , 'th': 'เอฟเค ซาราเยโว' },
  ...
  'Fulham': { 'ar': 'فولهام', 'de': 'Fulham', 'es': 'Fulham', 'fr': 'Fulham', 'ja': 'フラム', 'ko': '풀럼', 'la': 'Fulham', 'pt': 'Fulham', 'ru': 'Фулхэм', 'zh-CN': '富勒姆', 'zh-TW': '富勒姆' , 'th': 'ฟูแล่ม' },
  ...
  'Hapoel Ironi Kiryat Shmona': { 'de': 'Ironi Kiryat Shmona', 'es': 'Hapoel Ironi Kiryat Shmona', 'fr': 'Ironi Kiryat Shmona', 'ja': 'イロニ・キリヤット・シュモナ', 'ko': '하포엘 이로니 키르야트 시모나', 'la': 'Hapoel Ironi Kiryat Shmona', 'pt': 'Ironi Kiryat Shmona', 'ru': 'Хапоэль Ирони Кирьят-Шмона', 'zh-CN': '谢莫纳城伊罗尼', 'zh-TW': '謝莫納城伊羅尼' , 'th': 'ฮาโปเอล อิโรนี่ เคอร์ยัต ชโมน่า' },
  'Hapoel Jerusalem': { 'de': 'Hapoel Jerusalem', 'es': 'Hapoel Jerusalem', 'fr': 'Hapoel Jérusalem', 'ja': 'ハポエル・エルサレム', 'ko': '하포엘 예루살렘', 'la': 'Hapoel Jerusalem', 'pt': 'Hapoel Jerusalem', 'ru': 'Хапоэль Иерусалим', 'zh-CN': '耶路撒冷哈普尔', 'zh-TW': '耶路撒冷哈普爾' , 'th': 'ฮาโปเอล เยรูซาเลม' },
  ...
  'Ironi Tiberias': { 'de': 'Ironi Tiberias', 'es': 'Ironi Tiberias', 'fr': 'Ironi Tiberias', 'ja': 'イロニ・ティベリアス', 'ko': '이로니 티베리아스', 'la': 'Ironi Tiberias', 'pt': 'Ironi Tiberias', 'ru': 'Ирони Тверия', 'zh-CN': '铁比利亚伊罗尼', 'zh-TW': '鐵比利亞伊羅尼' , 'th': 'อิโรนี่ ทิเบเรียส' },
  ...
  'Ittihad Gharyan': { 'de': 'Ittihad Gharyan', 'es': 'Ittihad Gharyan', 'fr': 'Ittihad Gharyan', 'ja': 'イテハド・ガルヤン', 'ko': '이티하드 가르얀', 'la': 'Ittihad Gharyan', 'pt': 'Ittihad Gharyan', 'ru': 'Иттихад Гарьян', 'zh-CN': '伊蒂哈德盖尔扬', 'zh-TW': '伊蒂哈德蓋爾揚' , 'th': 'อิติฮัด ฆารยาน' },
  ...
  'Lillestroem': { 'de': 'Lillestrøm', 'es': 'Lillestrøm', 'fr': 'Lillestrøm', 'ja': 'リールストロム', 'ko': '릴레스트룀', 'la': 'Lillestroem', 'pt': 'Lillestrøm', 'ru': 'Лиллестрём', 'zh-CN': '利勒斯特罗姆', 'zh-TW': '利勒斯特羅姆' , 'th': 'ลีลสตรอม' },
  ...
  'Liverpool': { 'ar': 'ليفربول', 'de': 'Liverpool', 'es': 'Liverpool', 'fr': 'Liverpool', 'ja': 'リヴァプール', 'ko': '리버풀', 'la': 'Liverpool', 'pt': 'Liverpool', 'ru': 'Ливерпуль', 'zh-CN': '利物浦', 'zh-TW': '利物浦' , 'th': 'ลิเวอร์พูล' },
  ...
  'Luton Town': { 'ar': 'لوتون تاون', 'de': 'Luton Town', 'es': 'Luton Town', 'fr': 'Luton Town', 'ja': 'ルートン・タウン', 'ko': '루턴 타운', 'la': 'Luton Town', 'pt': 'Luton Town', 'ru': 'Лутон Таун', 'zh-CN': '卢顿', 'zh-TW': '盧頓' , 'th': 'ลูตัน ทาวน์' },
  ...
  'Manchester City': { 'ar': 'مانشستر سيتي', 'de': 'Manchester City', 'es': 'Manchester City', 'fr': 'Manchester City', 'ja': 'マンチェスター・シティ', 'ko': '맨체스터 시티', 'la': 'Manchester City', 'pt': 'Manchester City', 'ru': 'Манчестер Сити', 'zh-CN': '曼城', 'zh-TW': '曼城' , 'th': 'แมนเชสเตอร์ ซิตี้' },
  'Manchester United': { 'ar': 'مانشستر يونايتد', 'de': 'Manchester United', 'es': 'Manchester United', 'fr': 'Manchester United', 'ja': 'マンチェスター・ユナイテッド', 'ko': '맨체스터 유나이티드', 'la': 'Manchester United', 'pt': 'Manchester United', 'ru': 'Манчестер Юнайтед', 'zh-CN': '曼联', 'zh-TW': '曼聯' , 'th': 'แมนเชสเตอร์ ยูไนเต็ด' },
  ...
  'Maribor': { 'de': 'Maribor', 'es': 'Maribor', 'fr': 'Maribor', 'ja': 'マリボル', 'ko': '마리보르', 'la': 'Maribor', 'pt': 'Maribor', 'ru': 'Марибор', 'zh-CN': '马里博尔', 'zh-TW': '馬里博爾' , 'th': 'มาริบอร์' },
  ...
  'Newcastle': { 'ar': 'نيوكاسل', 'de': 'Newcastle', 'es': 'Newcastle', 'fr': 'Newcastle', 'ja': 'ニューカッスル', 'ko': '뉴캐슬', 'la': 'Newcastle', 'pt': 'Newcastle', 'ru': 'Ньюкасл', 'zh-CN': '纽卡斯尔联', 'zh-TW': '紐卡索聯' , 'th': 'นิวคาสเซิ่ล' },
  'Newcastle United': { 'ar': 'نيوكاسل', 'de': 'Newcastle', 'es': 'Newcastle', 'fr': 'Newcastle', 'ja': 'ニューカッスル', 'ko': '뉴캐슬', 'la': 'Newcastle', 'pt': 'Newcastle', 'ru': 'Ньюкасл', 'zh-CN': '纽卡斯尔联', 'zh-TW': '紐卡索聯' , 'th': 'นิวคาสเซิ่ล ยูไนเต็ด' },
  ...
  'NK Bravo': { 'de': 'NK Bravo', 'es': 'NK Bravo', 'fr': 'NK Bravo', 'ja': 'NKブラヴォ', 'ko': 'NK 브라보', 'la': 'NK Bravo', 'pt': 'NK Bravo', 'ru': 'НК Браво', 'zh-CN': '布拉沃', 'zh-TW': '布拉沃' , 'th': 'เอ็นเค บราโว่' },
  'NK Celje': { 'de': 'NK Celje', 'es': 'NK Celje', 'fr': 'NK Celje', 'ja': 'NKツェリェ', 'ko': 'NK 첼레', 'la': 'NK Celje', 'pt': 'NK Celje', 'ru': 'НК Целе', 'zh-CN': '采列', 'zh-TW': '采列' , 'th': 'เอ็นเค เซลเย่' },
  ...
  'Nottingham Forest': { 'ar': 'نوتينغهام فورست', 'de': 'Nottingham Forest', 'es': 'Nottingham Forest', 'fr': 'Nottingham Forest', 'ja': 'ノッティンガム・フォレスト', 'ko': '노팅엄 포레스트', 'la': 'Nottingham Forest', 'pt': 'Nottingham Forest', 'ru': 'Ноттингем Форест', 'zh-CN': '诺丁汉森林', 'zh-TW': '諾丁漢森林' , 'th': 'น็อตติ้งแฮม ฟอเรสต์' },
  ...
  'Omonia Nicosia': { 'de': 'Omonia Nicosia', 'es': 'Omonia Nicosia', 'fr': 'Omonia Nicosia', 'ja': 'オモニア・ニコシア', 'ko': '오모니아 니코시아', 'la': 'Omonia Nicosia', 'pt': 'Omonia Nicosia', 'ru': 'Омония Никосия', 'zh-CN': '奥莫尼亚', 'zh-TW': '奧摩尼亞' , 'th': 'โอโมเนีย นิโคเซีย' },
  ...
  'Partizan Beograd': { 'de': 'Partizan Belgrad', 'es': 'Partizán de Belgrado', 'fr': 'Partizan Belgrade', 'ja': 'パルチザン・ベオグラード', 'ko': '파르티잔 베오그라드', 'la': 'Partizan Beograd', 'pt': 'Partizan Belgrado', 'ru': 'Партизан Белград', 'zh-CN': '游击队', 'zh-TW': '游擊隊' , 'th': 'ปาร์ติซาน เบโอกราด' },
  ...
  'Raal La Louviere': { 'de': 'Raal La Louviere', 'es': 'RAAL La Louvière', 'fr': 'RAAL La Louvière', 'ja': 'ラ・ルヴィエール', 'ko': '라 루비에르', 'la': 'Raal La Louviere', 'pt': 'RAAL La Louvière', 'ru': 'Ла-Лувьер', 'zh-CN': '拉卢维耶尔', 'zh-TW': '拉盧維耶爾' , 'th': 'ราอัล ลา ลูวิแยร์' },
  ...
  'Sheffield United': { 'ar': 'شيفيلد يونايتد', 'de': 'Sheffield United', 'es': 'Sheffield United', 'fr': 'Sheffield United', 'ja': 'シェフィールド・ユナイテッド', 'ko': '셰필드 유나이티드', 'la': 'Sheffield United', 'pt': 'Sheffield United', 'ru': 'Шеффилд Юнайтед', 'zh-CN': '谢菲尔德联', 'zh-TW': '雪菲爾聯' , 'th': 'เชฟฟิลด์ ยูไนเต็ด' },
  ...
  'Siroki Brijeg': { 'de': 'Široki Brijeg', 'es': 'Široki Brijeg', 'fr': 'Široki Brijeg', 'ja': 'シロキ・ブリイェグ', 'ko': '시로키 브리예그', 'la': 'Siroki Brijeg', 'pt': 'Široki Brijeg', 'ru': 'Широки Бриег', 'zh-CN': '希洛基布里耶格', 'zh-TW': '希洛基布里耶格' , 'th': 'ซิโรกี บริเยก' },
  ...
  'Slovan Bratislava': { 'de': 'Slovan Bratislava', 'es': 'Slovan Bratislava', 'fr': 'Slovan Bratislava', 'ja': 'スロヴァン・ブラチスラヴァ', 'ko': '슬로반 브라티슬라바', 'la': 'Slovan Bratislava', 'pt': 'Slovan Bratislava', 'ru': 'Слован Братислава', 'zh-CN': '布拉迪斯拉发', 'zh-TW': '布拉提斯拉瓦' , 'th': 'สโลวาน บราติสลาวา' },
  ...
  'Sunderland': { 'ar': 'سندرلاند', 'de': 'Sunderland', 'es': 'Sunderland', 'fr': 'Sunderland', 'ja': 'サンダーランド', 'ko': '선덜랜드', 'la': 'Sunderland', 'pt': 'Sunderland', 'ru': 'Сандерленд', 'zh-CN': '桑德兰', 'zh-TW': '桑德蘭' , 'th': 'ซันเดอร์แลนด์' },
  ...
  'Tottenham': { 'ar': 'توتنهام', 'de': 'Tottenham', 'es': 'Tottenham', 'fr': 'Tottenham', 'ja': 'トッテナム', 'ko': '토트넘', 'la': 'Tottenham', 'pt': 'Tottenham', 'ru': 'Тоттенхэм', 'zh-CN': '托特纳姆热刺', 'zh-TW': '熱刺' , 'th': 'ท็อตแน่ม' },
  'Tottenham Hotspur': { 'ar': 'توتنهام', 'de': 'Tottenham', 'es': 'Tottenham', 'fr': 'Tottenham', 'ja': 'トッテナム', 'ko': '토트넘', 'la': 'Tottenham', 'pt': 'Tottenham', 'ru': 'Тоттенхэм', 'zh-CN': '托特纳姆热刺', 'zh-TW': '熱刺' , 'th': 'ท็อตแน่ม ฮ็อทสเปอร์' },
  ...
  'Union St.Gilloise': { 'de': 'Union St.Gilloise', 'es': 'Union St. Gilloise', 'fr': 'Union St. Gilloise', 'ja': 'ユニオン・サン＝ジロワーズ', 'ko': '루아얄 위니옹 생질루아즈', 'la': 'Union St.Gilloise', 'pt': 'Union St. Gilloise', 'ru': 'Юнион Сент-Жиллуаз', 'zh-CN': '圣吉罗斯', 'zh-TW': '聖吉羅斯' , 'th': 'ยูเนี่ยน เซนต์ กิลลอยส์' },
  ...
  'Vancouver FC': { 'de': 'Vancouver FC', 'es': 'Vancouver FC', 'fr': 'Vancouver FC', 'ja': 'バンクーバーFC', 'ko': '밴쿠버 FC', 'la': 'Vancouver FC', 'pt': 'Vancouver FC', 'ru': 'Ванкувер', 'zh-CN': '温哥华FC', 'zh-TW': '溫哥華FC' , 'th': 'แวนคูเวอร์ เอฟซี' },
  ...
  'West Ham': { 'ar': 'وست هام', 'de': 'West Ham', 'es': 'West Ham', 'fr': 'West Ham', 'ja': 'ウェストハム', 'ko': '웨스트햄', 'la': 'West Ham', 'pt': 'West Ham', 'ru': 'Вест Хэм', 'zh-CN': '西汉姆联', 'zh-TW': '西漢姆聯' , 'th': 'เวสต์แฮม' },
  'West Ham United': { 'ar': 'وست هام', 'de': 'West Ham', 'es': 'West Ham', 'fr': 'West Ham', 'ja': 'ウェストハム', 'ko': '웨스트햄', 'la': 'West Ham', 'pt': 'West Ham', 'ru': 'Вест Хэм', 'zh-CN': '西汉姆联', 'zh-TW': '西漢姆聯' , 'th': 'เวสต์แฮม ยูไนเต็ด' },
  ...
  'Wolverhampton Wanderers': { 'ar': 'وولفرهامبتون', 'de': 'Wolves', 'es': 'Wolves', 'fr': 'Wolves', 'ja': 'ウルヴァーハンプトン', 'ko': '울버햄튼', 'la': 'Wolves', 'pt': 'Wolves', 'ru': 'Вулверхэмптон', 'zh-CN': '狼队', 'zh-TW': '狼隊' , 'th': 'วูล์ฟแฮมป์ตัน วันเดอร์เรอร์ส' },
  'Wolves': { 'ar': 'وولفرهامبتون', 'de': 'Wolves', 'es': 'Wolves', 'fr': 'Wolves', 'ja': 'ウルブス', 'ko': '울브스', 'la': 'Wolves', 'pt': 'Wolves', 'ru': 'Вулверхэмптон', 'zh-CN': '狼队', 'zh-TW': '狼隊' , 'th': 'หมาป่า' },
  ...
  'Zeleznicar Pancevo': { 'de': 'Železničar Pančevo', 'es': 'Železničar Pančevo', 'fr': 'Železničar Pančevo', 'ja': 'ジェレズニチャル・パンチェヴォ', 'ko': '젤레즈니차르 판체보', 'la': 'Zeleznicar Pancevo', 'pt': 'Železničar Pančevo', 'ru': 'Железничар Панчево', 'zh-CN': '潘切沃铁路', 'zh-TW': '潘切沃鐵路' , 'th': 'เซเลซนิการ์ ปานเชโว' },
...
const COUNTRY_NAMES: Record<string, Record<string, string>> = {
  'Iraq': { 'zh-TW': '伊拉克', 'zh-CN': '伊拉克', 'es': 'Irak', 'ja': 'イラク', 'ko': '이라크', 'pt': 'Iraque', 'la': 'Iraquia', 'ru': 'Ирак', 'fr': 'Irak', 'de': 'Irak', 'ar': 'العراق' },
  'England': { 'zh-TW': '英格蘭', 'zh-CN': '英格兰', 'es': 'Inglaterra', 'ja': 'イングランド', 'ko': '잉글랜드', 'pt': 'Inglaterra', 'la': 'Anglia', 'ru': 'Англия', 'fr': 'Angleterre', 'de': 'England', 'ar': 'إنجلترا' },
  'Japan': { 'zh-TW': '日本', 'zh-CN': '日本', 'es': 'Japón', 'ja': '日本', 'ko': '일본', 'pt': 'Japão', 'la': 'Iaponia', 'ru': 'Япония', 'fr': 'Japon', 'de': 'Japan', 'ar': 'اليابان' },
  'Norway': { 'zh-TW': '挪威', 'zh-CN': '挪威', 'es': 'Noruega', 'ja': 'ノルウェー', 'ko': '노르웨이', 'pt': 'Noruega', 'la': 'Norvegia', 'ru': 'Норвегия', 'fr': 'Norvège', 'de': 'Norwegen', 'ar': 'النرويج' },
  'Mexico': { 'zh-TW': '墨西哥', 'zh-CN': '墨西哥', 'es': 'México', 'ja': 'メキシコ', 'ko': '멕시코', 'pt': 'México', 'la': 'Mexicum', 'ru': 'Мексика', 'fr': 'Mexique', 'de': 'Mexiko', 'ar': 'المكسيك' },
  'Argentina': { 'zh-TW': '阿根廷', 'zh-CN': '阿根廷', 'es': 'Argentina', 'ja': 'アルゼンチン', 'ko': '아르헨티나', 'pt': 'Argentina', 'la': 'Argentina', 'ru': 'Аргентина', 'fr': 'Argentine', 'de': 'Argentinien', 'ar': 'الأرجنتين' },
  'Saudi Arabia': { 'zh-TW': '沙特阿拉伯', 'zh-CN': '沙特阿拉伯', 'es': 'Arabia Saudita', 'ja': 'サウジアラビア', 'ko': '사우디아라비아', 'pt': 'Arábia Saudita', 'la': 'Arabia Saudiana', 'ru': 'Саудовская Аравия', 'fr': 'Arabie Saoudite', 'de': 'Saudi-Arabien', 'ar': 'السعودية' },
  'Qatar': { 'zh-TW': '卡塔爾', 'zh-CN': '卡塔尔', 'es': 'Catar', 'ja': 'カタール', 'ko': '카타르', 'pt': 'Catar', 'la': 'Quataria', 'ru': 'Катар', 'fr': 'Qatar', 'de': 'Katar', 'ar': 'قطر' },
  'Russia': { 'zh-TW': '俄羅斯', 'zh-CN': '俄罗斯', 'es': 'Rusia', 'ja': 'ロシア', 'ko': '러시아', 'pt': 'Rússia', 'la': 'Russia', 'ru': 'Россия', 'fr': 'Russie', 'de': 'Russland', 'ar': 'روسيا' },
  'Australia': { 'zh-TW': '澳洲', 'zh-CN': '澳大利亚', 'es': 'Australia', 'ja': 'オーストラリア', 'ko': '호주', 'pt': 'Austrália', 'la': 'Australia', 'ru': 'Австралия', 'fr': 'Australie', 'de': 'Australien', 'ar': 'أستراليا' },
  'Serbia': { 'zh-TW': '塞爾維亞', 'zh-CN': '塞尔维亚', 'es': 'Serbia', 'ja': 'セルビア', 'ko': '세르비아', 'pt': 'Sérvia', 'la': 'Serbia', 'ru': 'Сербия', 'fr': 'Serbie', 'de': 'Serbien', 'ar': 'صربيا' },
  'Austria': { 'zh-TW': '奧地利', 'zh-CN': '奥地利', 'es': 'Austria', 'ja': 'オーストリア', 'ko': '오스트리아', 'pt': 'Áustria', 'la': 'Austria', 'ru': 'Австрия', 'fr': 'Autriche', 'de': 'Österreich', 'ar': 'النمسا' },
  'Moldova': { 'zh-TW': '摩爾多瓦', 'zh-CN': '摩尔多瓦', 'es': 'Moldavia', 'ja': 'モルドバ', 'ko': '몰도바', 'pt': 'Moldávia', 'la': 'Moldavia', 'ru': 'Молдова', 'fr': 'Moldavie', 'de': 'Moldau', 'ar': 'مولدوفا' },
  'Scotland': { 'zh-TW': '蘇格蘭', 'zh-CN': '苏格兰', 'es': 'Escocia', 'ja': 'スコットランド', 'ko': '스코틀랜드', 'pt': 'Escócia', 'la': 'Scotia', 'ru': 'Шотландия', 'fr': 'Écosse', 'de': 'Schottland', 'ar': 'اسكتلندا' },
  'Malta': { 'zh-TW': '馬耳他', 'zh-CN': '马耳他', 'es': 'Malta', 'ja': 'マルタ', 'ko': '몰타', 'pt': 'Malta', 'la': 'Melita', 'ru': 'Мальта', 'fr': 'Malte', 'de': 'Malta', 'ar': 'مالطا' },
  'Denmark': { 'zh-TW': '丹麥', 'zh-CN': '丹麦', 'es': 'Dinamarca', 'ja': 'デンマーク', 'ko': '덴마크', 'pt': 'Dinamarca', 'la': 'Dania', 'ru': 'Дания', 'fr': 'Danemark', 'de': 'Dänemark', 'ar': 'الدنمارك' },
  'Cyprus': { 'zh-TW': '塞浦路斯', 'zh-CN': '塞浦路斯', 'es': 'Chipre', 'ja': 'キプロス', 'ko': '키프로스', 'pt': 'Chipre', 'la': 'Cyprus', 'ru': 'Кипр', 'fr': 'Chypre', 'de': 'Zypern', 'ar': 'قبرص' },
  'Belgium': { 'zh-TW': '比利時', 'zh-CN': '比利时', 'es': 'Bélgica', 'ja': 'ベルギー', 'ko': '벨기에', 'pt': 'Bélgica', 'la': 'Belgica', 'ru': 'Бельгия', 'fr': 'Belgique', 'de': 'Belgien', 'ar': 'بلجيكا' },
  'Slovakia': { 'zh-TW': '斯洛伐克', 'zh-CN': '斯洛伐克', 'es': 'Eslovaquia', 'ja': 'スロバキア', 'ko': '슬로바키아', 'pt': 'Eslováquia', 'la': 'Slovacia', 'ru': 'Словакия', 'fr': 'Slovaquie', 'de': 'Slowakei', 'ar': 'سلوفاكيا' },
  'Romania': { 'zh-TW': '羅馬尼亞', 'zh-CN': '罗马尼亚', 'es': 'Rumania', 'ja': 'ルーマニア', 'ko': '루마니아', 'pt': 'Romênia', 'la': 'Romania', 'ru': 'Румыния', 'fr': 'Roumanie', 'de': 'Rumänien', 'ar': 'رومانيا' },
  'Egypt': { 'zh-TW': '埃及', 'zh-CN': '埃及', 'es': 'Egipto', 'ja': 'エジプト', 'ko': '이집트', 'pt': 'Egito', 'la': 'Aegyptus', 'ru': 'Египет', 'fr': 'Égypte', 'de': 'Ägypten', 'ar': 'مصر' },
  'Slovenia': { 'zh-TW': '斯洛維尼亞', 'zh-CN': '斯洛文尼亚', 'es': 'Eslovenia', 'ja': 'スロベニア', 'ko': '슬로베니아', 'pt': 'Eslovênia', 'la': 'Slovenia', 'ru': 'Словения', 'fr': 'Slovénie', 'de': 'Slowenien', 'ar': 'سلوفينيا' },
  'Peru': { 'zh-TW': '秘魯', 'zh-CN': '秘鲁', 'es': 'Perú', 'ja': 'ペルー', 'ko': '페루', 'pt': 'Peru', 'la': 'Peruvia', 'ru': 'Перу', 'fr': 'Pérou', 'de': 'Peru', 'ar': 'بيرو' },
  'Israel': { 'zh-TW': '以色列', 'zh-CN': '以色列', 'es': 'Israel', 'ja': 'イスラエル', 'ko': '이스라엘', 'pt': 'Israel', 'la': 'Israël', 'ru': 'Израиль', 'fr': 'Israël', 'de': 'Israel', 'ar': 'إسرائيل' },
  'South Africa': { 'zh-TW': '南非', 'zh-CN': '南非', 'es': 'Sudáfrica', 'ja': '南アフリカ', 'ko': '남아프리카', 'pt': 'África do Sul', 'la': 'Africa Australis', 'ru': 'Южная Африка', 'fr': 'Afrique du Sud', 'de': 'Südafrika', 'ar': 'جنوب أفريقيا' },
  'Libya': { 'zh-TW': '利比亞', 'zh-CN': '利比亚', 'es': 'Libia', 'ja': 'リビア', 'ko': '리비아', 'pt': 'Líbia', 'la': 'Libya', 'ru': 'Ливия', 'fr': 'Libye', 'de': 'Libyen', 'ar': 'ليبيا' },
  'Germany': { 'zh-TW': '德國', 'zh-CN': '德国', 'es': 'Alemania', 'ja': 'ドイツ', 'ko': '독일', 'pt': 'Alemanha', 'la': 'Germania', 'ru': 'Германия', 'fr': 'Allemagne', 'de': 'Deutschland', 'ar': 'ألمانيا' },
  'Canada': { 'zh-TW': '加拿大', 'zh-CN': '加拿大', 'es': 'Canadá', 'ja': 'カナダ', 'ko': '캐나다', 'pt': 'Canadá', 'la': 'Canada', 'ru': 'Канада', 'fr': 'Canada', 'de': 'Kanada', 'ar': 'كندا' },
  'Bosnia and Herzegovina': { 'zh-TW': '波士尼亞與赫塞哥維納', 'zh-CN': '波斯尼亚和黑塞哥维那', 'es': 'Bosnia y Herzegovina', 'ja': 'ボスニア・ヘルツェゴビナ', 'ko': '보스니아 헤르체고비나', 'pt': 'Bósnia e Herzegovina', 'la': 'Bosnia et Herzegovina', 'ru': 'Босния и Герцеговина', 'fr': 'Bosnie-Herzégovine', 'de': 'Bosnien und Herzegowina', 'ar': 'البوسنة والهرسك' },
  'Armenia': { 'zh-TW': '亞美尼亞', 'zh-CN': '亚美尼亚', 'es': 'Armenia', 'ja': 'アルメニア', 'ko': '아르메니아', 'pt': 'Armênia', 'la': 'Armenia', 'ru': 'Армения', 'fr': 'Arménie', 'de': 'Armenien', 'ar': 'أرمينيا' },
  'Tanzania': { 'zh-TW': '坦尚尼亞', 'zh-CN': '坦桑尼亚', 'es': 'Tanzania', 'ja': 'タンザニア', 'ko': '탄자니아', 'pt': 'Tanzânia', 'la': 'Tanzania', 'ru': 'Танзания', 'fr': 'Tanzanie', 'de': 'Tansania', 'ar': 'تنزانيا' },
  'Ireland': { 'zh-TW': '愛爾蘭', 'zh-CN': '爱尔兰', 'es': 'Irlanda', 'ja': 'アイルランド', 'ko': '아일랜드', 'pt': 'Irlanda', 'la': 'Hibernia', 'ru': 'Ирландия', 'fr': 'Irlande', 'de': 'Irland', 'ar': 'أيرلندا' },
  'Northern Ireland': { 'zh-TW': '北愛爾蘭', 'zh-CN': '北爱尔兰', 'es': 'Irlanda del Norte', 'ja': '北アイルランド', 'ko': '북아일랜드', 'pt': 'Irlanda do Norte', 'la': 'Hibernia Septentrionalis', 'ru': 'Северная Ирландия', 'fr': 'Irlande du Nord', 'de': 'Nordirland', 'ar': 'أيرلندا الشمالية' },
  'Ghana': { 'zh-TW': '加納', 'zh-CN': '加纳', 'es': 'Ghana', 'ja': 'ガーナ', 'ko': '가나', 'pt': 'Gana', 'la': 'Ghana', 'ru': 'Гана', 'fr': 'Ghana', 'de': 'Ghana', 'ar': 'غانا' },
  'Kazakhstan': { 'zh-TW': '哈薩克', 'zh-CN': '哈萨克斯坦', 'es': 'Kazajistán', 'ja': 'カザフスタン', 'ko': '카자흐스탄', 'pt': 'Cazaquistão', 'la': 'Kazachstania', 'ru': 'Казахстан', 'fr': 'Kazakhstan', 'de': 'Kasachstan', 'ar': 'كازاخستان' },
  'India': { 'zh-TW': '印度', 'zh-CN': '印度', 'es': 'India', 'ja': 'インド', 'ko': '인도', 'pt': 'Índia', 'la': 'India', 'ru': 'Индия', 'fr': 'Inde', 'de': 'Indien', 'ar': 'الهند' },
  'Kenya': { 'zh-TW': '肯亞', 'zh-CN': '肯尼亚', 'es': 'Kenia', 'ja': 'ケニア', 'ko': '케냐', 'pt': 'Quênia', 'la': 'Kenya', 'ru': 'Кения', 'fr': 'Kenya', 'de': 'Kenia', 'ar': 'كينيا' },
  'Hong Kong': { 'zh-TW': '香港', 'zh-CN': '香港', 'es': 'Hong Kong', 'ja': '香港', 'ko': '홍콩', 'pt': 'Hong Kong', 'la': 'Hong Kong', 'ru': 'Гонконг', 'fr': 'Hong Kong', 'de': 'Hongkong', 'ar': 'هونغ كونغ' },
  'South Korea': { 'zh-TW': '南韓', 'zh-CN': '韩国', 'es': 'Corea del Sur', 'ja': '韓国', 'ko': '대한민국', 'pt': 'Coreia do Sul', 'la': 'Corea Australis', 'ru': 'Южная Корея', 'fr': 'Corée du Sud', 'de': 'Südkorea', 'ar': 'كوريا الجنوبية' },
  'Republic of Korea': { 'zh-TW': '南韓', 'zh-CN': '韩国', 'es': 'Corea del Sur', 'ja': '韓国', 'ko': '대한민국', 'pt': 'Coreia do Sul', 'la': 'Corea Australis', 'ru': 'Южная Корея', 'fr': 'Corée du Sud', 'de': 'Südkorea', 'ar': 'كوريا الجنوبية' },
  'Jamaica': { 'zh-TW': '牙買加', 'zh-CN': '牙买加', 'es': 'Jamaica', 'ja': 'ジャマイカ', 'ko': '자메이카', 'pt': 'Jamaica', 'la': 'Iamaica', 'ru': 'Ямайка', 'fr': 'Jamaïque', 'de': 'Jamaika', 'ar': 'جامايكا' },
  'Ukraine': { 'zh-TW': '烏克蘭', 'zh-CN': '乌克兰', 'es': 'Ucrania', 'ja': 'ウクライナ', 'ko': '우크라이나', 'pt': 'Ucrânia', 'la': 'Ucraina', 'ru': 'Украина', 'fr': 'Ukraine', 'de': 'Ukraine', 'ar': 'أوكرانيا' },
  'Singapore': { 'zh-TW': '新加坡', 'zh-CN': '新加坡', 'es': 'Singapur', 'ja': 'シンガポール', 'ko': '싱가포르', 'pt': 'Singapura', 'la': 'Singapura', 'ru': 'Сингапур', 'fr': 'Singapour', 'de': 'Singapur', 'ar': 'سنغافورة' },
  'Azerbaijan': { 'zh-TW': '亞塞拜然', 'zh-CN': '阿塞拜疆', 'es': 'Azerbaiyán', 'ja': 'アゼルバイジャン', 'ko': '아제르바이잔', 'pt': 'Azerbaijão', 'la': 'Atropatene', 'ru': 'Азербайджан', 'fr': 'Azerbaïdjan', 'de': 'Aserbaidschan', 'ar': 'أذربيجان' },
  'Bahrain': { 'zh-TW': '巴林', 'zh-CN': '巴林', 'es': 'Baréin', 'ja': 'バーレーン', 'ko': '바레인', 'pt': 'Bahrein', 'la': 'Baharina', 'ru': 'Бахрейн', 'fr': 'Bahreïn', 'de': 'Bahrain', 'ar': 'البحرين' },
};
...
export async function GET(request: NextRequest) {
  try {
    ...
    const getTeamName = async (name: string, id?: string) => {
      ...
      if (EURO_DIRECT.has(lang)) return name;
        ...
        for (const event of stage.Events) {
          matchPromises.push((async () => {
            ...
            if (isLive) {
                ...
                else if (lang === 'la') livePrefix = 'Vivus';
