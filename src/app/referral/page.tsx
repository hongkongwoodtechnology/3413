                ...
                <div className="bg-neutral-900 p-8 rounded-b-3xl border border-neutral-800 shadow-2xl space-y-8">
                    ...
                    <div className="grid lg:grid-cols-3 gap-8">
                        ...
                        <div className="lg:col-span-1">
                            <div className="bg-gradient-to-b from-neutral-800 to-neutral-900 p-8 rounded-3xl border border-neutral-700/50 h-full flex flex-col relative overflow-hidden">
                                ...
                                <div className="flex-1 space-y-8 relative z-10">
                                    <div className="space-y-3">
                                        ...
                                        <div className="text-4xl font-bold text-white tracking-tight">{stats.withdrawable}</div>
                                    </div>
